      ...
      <div className="container px-4 md:px-10 lg:px-24 mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12 mt-8">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold font-poppins mb-4 md:mb-7">
              Funiro.
            </h2>
          ...
          {/* Links Section */}
          <div className="space-y-4">
            <h3 className="text-gray-500 font-poppins font-medium mb-4 md:mb-7">
              Links
            </h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
              ...
              <button
                ...
                className="border-b border-black pb-1 text-sm font-poppins font-medium"
              >
                SUBSCRIBE
              </button>
            </div>
